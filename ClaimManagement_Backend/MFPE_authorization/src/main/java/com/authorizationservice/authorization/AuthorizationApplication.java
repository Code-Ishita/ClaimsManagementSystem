...
public class AuthorizationApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception{
		AuthenticationRequest user1 = new AuthenticationRequest("ishita","password1234");
		AuthenticationRequest user2 = new AuthenticationRequest("harshita","password1234");
		AuthenticationRequest user3 = new AuthenticationRequest("vivaan","password1234");
